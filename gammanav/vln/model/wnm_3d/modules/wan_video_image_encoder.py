...
def flash_attention(q, k, v, num_heads, compatibility_mode=True):
    """SDPA helper for CLIP tensors in [batch, sequence, channels] layout."""
...
class WanImageEncoder(torch.nn.Module):
    ...
    def encode_image(self, videos):
        ...
        videos = self.normalize(videos.mul_(0.5).add_(0.5))
